...
import org.example.ordermanagementsystem.data.repository.OrderRepositoryJVM
import org.example.ordermanagementsystem.ui.OrderDashboardDesktop
...
fun main() = application {
    Window(
        ...
        OrderDashboardDesktop(viewModel)
